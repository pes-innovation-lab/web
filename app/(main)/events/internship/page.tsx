  ...
  return (
    <Container>
      ...
      <div style={{ marginTop: '2rem', color: 'white' }}>
        ...
        <Typography variant="h6" style={{ color: '#068f13', marginTop: '2rem', marginBottom: '1rem' }}>
          Project Domains
        </Typography>
        ...
        <ul style={{ color: 'white' }}>
          ...
          <li>
            <Typography variant="body1">Sensor Networking</Typography>
          </li>
          <li>
            <Typography variant="body1">Virtual Reality</Typography>
          </li>
          <li>
            <Typography variant="body1">Brain-Computer Interface</Typography>
          </li>
          <li>
