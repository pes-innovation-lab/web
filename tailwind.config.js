    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                'lab-accent': 'var(--lab-accent)',
                'lab-light-green': 'var(--lab-light-green)',
                'lab-bg': 'var(--lab-bg)',
                'lab-sec': 'var(--lab-sec)',
                'lab-sec-transparent': 'var(--lab-sec-transparent)',
                'blog-text-primary': 'var(--blog-text-primary)',
                'blog-text-secondary': 'var(--blog-text-secondary)',
                'blog-heading-primary': 'var(--blog-heading-primary)',
                'blog-heading-accent': 'var(--blog-heading-accent)',
                'blog-heading-secondary': 'var(--blog-heading-secondary)',
                'blog-border-primary': 'var(--blog-border-primary)',
                'blog-border-secondary': 'var(--blog-border-secondary)',
                'blog-bg-primary': 'var(--blog-bg-primary)',
                'blog-bg-secondary': 'var(--blog-bg-secondary)',
                'navbar-border': 'var(--navbar-border-color)',
                'sidebar-border': 'var(--sidebar-border-color)',
                'card-border': 'var(--card-border-color)',
                'lab-accent-border': 'var(--lab-accent-border)',
            },
            boxShadow: {
                'accent-glow':
                    '0 15px 30px -8px var(--lab-accent-shadow), 0 0 0 1px var(--lab-accent-glow)',
            },
            screens: {
                // ph: { max: '1024px' },
                phone: '426px',
